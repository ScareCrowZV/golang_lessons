...
func main() {
	...
	io.WriteString(os.Stdout, "Вывод строки с помощью записи в поток стандартного вывода \n")

	fmt.Print("Вывод без перехода на новую строку")
	fmt.Println("Вывод с переходом на новую строку")

	fmt.Printf("вывод с форматирование данных, например, для вывода числа: %d\n", 5)
	formattedString := fmt.Sprintf("получение форматированной строки без вывода: %d\n", 5)
